...
export const ChapterNavigation: React.FC<ChapterNavigationProps> = ({ onOpenCurriculum }) => {
  return (
    <nav aria-label="前後章節跳轉" className="my-12 border-t border-slate-800 pt-8">
      {/* Primary Prev/Next Buttons */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* Previous Chapter: Chapter 02 */}
        <div className="flex flex-col p-4 sm:p-5 rounded-xl border border-slate-800 bg-slate-900/90 hover:border-slate-700 transition-colors shadow-xs">
          ...
          <button
            ...
            className="mt-3 text-xs font-semibold text-emerald-400 hover:text-emerald-300 inline-flex items-center gap-1 self-start"
          >
        ...
        <div className="flex flex-col p-4 sm:p-5 rounded-xl border border-slate-800 bg-slate-900/90 hover:border-slate-700 transition-colors shadow-xs sm:text-right">
          <span className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1 flex items-center gap-1 sm:justify-end">
          ...
          <button
            type="button"
            onClick={onOpenCurriculum}
            className="mt-3 text-xs font-semibold text-emerald-400 hover:text-emerald-300 inline-flex items-center gap-1 self-start sm:self-end"
          >
      ...
      <div className="mt-6 p-4 sm:p-5 rounded-xl bg-slate-900/50 border border-slate-800">
