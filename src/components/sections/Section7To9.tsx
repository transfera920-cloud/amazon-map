  ...
  return (
    <>
      ...
      <section id="s7" aria-labelledby="heading-s7" className="scroll-mt-24 mb-20">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 text-base sm:text-lg leading-relaxed space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6 not-prose">
            <div className="p-4 rounded-lg border border-stone-200 bg-white">
              ...
              <h4 className="font-bold text-stone-900 text-base">只依靠布條（路條）</h4>
            ...
            <div className="p-4 rounded-lg border border-stone-200 bg-white">
              ...
              <h4 className="font-bold text-stone-900 text-base">只依靠單一手機 APP</h4>
              <p className="text-xs sm:text-sm text-stone-600 mt-1.5 leading-relaxed">
            ...
            <div className="p-4 rounded-lg border border-stone-200 bg-white">
              ...
              <h4 className="font-bold text-stone-900 text-base">不提前研究路線</h4>
              <p className="text-xs sm:text-sm text-stone-600 mt-1.5 leading-relaxed">
            ...
            <div className="p-4 rounded-lg border border-stone-200 bg-white">
              ...
              <h4 className="font-bold text-stone-900 text-base">發現迷路後盲目移動</h4>
              <p className="text-xs sm:text-sm text-stone-600 mt-1.5 leading-relaxed">
        ...
        {/* Section 16 迷途處置原則修正 */}
        <div className="my-8 p-6 rounded-xl border border-stone-300 bg-stone-50 shadow-xs">
          ...
          <p className="text-sm text-stone-600 leading-relaxed mb-4">
            當察覺周遭地形與地圖不符，或已無法看見明確路跡時，必須依照客觀程序處理。請注意：<strong>「原地等待」或「原路折返」並非在所有情境下都適用的固定教條</strong>，關鍵在於依據客觀條件綜合權衡。
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 not-prose">
            <div className="p-4 rounded-lg bg-white border border-stone-200">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                <strong>立即停止無目的的盲目移動。</strong>坐下深呼吸，喝口溫水，穩定心率與恐慌情緒，防止體力在慌亂探索中無謂耗盡。
              </p>
            </div>
      ...
      <section id="s8" aria-labelledby="heading-s8" className="scroll-mt-24 mb-20">
        ...
        <div className="prose prose-stone max-w-none text-stone-700 text-base sm:text-lg leading-relaxed space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 my-6 not-prose">
            {/* Tool 1 */}
            <div className="p-5 rounded-xl border border-stone-200 bg-white shadow-xs flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2 mb-2 text-stone-900 font-bold text-base">
                  <MapIcon className="w-5 h-5 text-emerald-800" />
                  <span>紙本地圖 (Paper Map)</span>
                </div>
                <ul className="space-y-1.5 text-xs sm:text-sm text-stone-600 mt-3">
                  <li className="text-emerald-800 font-medium">✓ 優點：不需任何電力，低溫不關機</li>
                  <li className="text-emerald-800 font-medium">✓ 優點：展開視野大，掌握宏觀山勢</li>
                  <li className="text-stone-500">✕ 限制：需投入時間學習等高線判讀</li>
                  <li className="text-stone-500">✕ 限制：需使用防水袋密封防潮防撕裂</li>
                </ul>
              </div>
            ...
            <div className="p-5 rounded-xl border border-stone-200 bg-white shadow-xs flex flex-col justify-between">
              <div>
                ...
                <ul className="space-y-1.5 text-xs sm:text-sm text-stone-600 mt-3">
                  <li className="text-emerald-800 font-medium">✓ 優點：純物理磁力指示，反應即時</li>
                  <li className="text-emerald-800 font-medium">✓ 優點：協助地圖與現場山勢精準對正</li>
                  <li className="text-stone-500">✕ 限制：易受金屬裝備、高壓電磁干擾</li>
                  <li className="text-stone-500">✕ 限制：無法單獨告知使用者自身座標</li>
                </ul>
              </div>
              <div className="mt-4 pt-3 border-t border-stone-100 text-xs text-stone-500">
                定位角色：提供客觀物理北方與航向方位角
            ...
            <div className="p-5 rounded-xl border border-stone-200 bg-white shadow-xs flex flex-col justify-between">
              <div>
                ...
                <ul className="space-y-1.5 text-xs sm:text-sm text-stone-600 mt-3">
                  <li className="text-emerald-800 font-medium">✓ 優點：定位迅速，即時呈現坐標數值</li>
                  <li className="text-emerald-800 font-medium">✓ 優點：自動記錄並疊加航跡軌跡圖</li>
                  <li className="text-stone-500">✕ 限制：極度依賴電池，強光低溫易失常</li>
                  <li className="text-stone-500">✕ 限制：需防摔防水，深谷衛星可能遮蔽</li>
                </ul>
              </div>
              <div className="mt-4 pt-3 border-t border-stone-100 text-xs text-stone-500">
                定位角色：快速查核當前位置與航跡偏移
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-4 not-prose">
            <div className="p-3.5 rounded-lg bg-stone-50 border border-stone-200 flex items-start gap-2.5">
              <BatteryCharging className="w-4 h-4 text-emerald-800 shrink-0 mt-0.5" />
              <div className="text-xs sm:text-sm">
                <strong>電量與保暖：</strong>攜帶充足且認證之行動電源；高山低溫環境下將手機置於貼身內層衣物保暖。
              </div>
            </div>
            <div className="p-3.5 rounded-lg bg-stone-50 border border-stone-200 flex items-start gap-2.5">
              <Layers className="w-4 h-4 text-emerald-800 shrink-0 mt-0.5" />
              <div className="text-xs sm:text-sm">
                <strong>離線圖資預載：</strong>山區通常無電信訊號，出發前必須在家中將完整區域地圖與 GPX 檔案下載至本地端。
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="prose prose-stone max-w-none text-stone-700 text-base sm:text-lg leading-relaxed space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6 not-prose">
            <div className="p-5 rounded-xl border border-stone-200 bg-white">
              ...
              <h4 className="text-base font-bold text-stone-900 mb-2">GPS 專用機 / 手機離線導航 APP</h4>
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed mb-3">
                在正常行程中擔任第一線定位確認工具，提供快速坐標回報、里程記錄與預載航跡比對，大幅提升行進效率。
              </p>
              <div className="p-2.5 rounded bg-stone-50 border border-stone-200 text-xs text-stone-600">
            ...
            <div className="p-5 rounded-xl border border-stone-200 bg-white">
              ...
              <h4 className="text-base font-bold text-stone-900 mb-2">紙本地圖 ＋ 磁性指南針 ＋ 地形判讀</h4>
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed mb-3">
