        ...
        <div className="prose prose-invert max-w-none text-slate-300 text-base sm:text-lg leading-relaxed space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6 not-prose">
            <div className="p-4 rounded-lg border border-slate-800 bg-slate-900/90 flex items-start gap-3">
              <div className="p-2 rounded-md bg-slate-800 text-slate-300 shrink-0">
                <MapPinOff className="w-5 h-5" aria-hidden="true" />
              </div>
              <div>
                <h4 className="font-bold text-slate-100 text-base">路徑不明顯</h4>
            ...
            <div className="p-4 rounded-lg border border-slate-800 bg-slate-900/90 flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-slate-100 text-base">天氣降低視線</h4>
                <p className="text-xs sm:text-sm text-slate-400 mt-1">
            ...
            <div className="p-4 rounded-lg border border-slate-800 bg-slate-900/90 flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-slate-100 text-base">叉路增加判斷難度</h4>
                <p className="text-xs sm:text-sm text-slate-400 mt-1">
            ...
            <div className="p-4 rounded-lg border border-slate-800 bg-slate-900/90 flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-slate-100 text-base">標示不足或損毀</h4>
                <p className="text-xs sm:text-sm text-slate-400 mt-1">
          ...
          <p>
            導航能力的終極目的，並不是<strong className="text-slate-100">「看著地圖或螢幕跟著走一條線」</strong>，因為螢幕上的軌跡無法替你觀察腳下的地形懸崖。真正的導航能力，是讓登山者在任何時刻都能持續回答兩個核心問題：
          </p>

          <ul className="list-disc pl-6 space-y-2 font-medium text-slate-200">
            <li><strong className="text-slate-100">「我現在在哪？」</strong>（確認當下空間位置與周遭地形特徵）</li>
            <li><strong className="text-slate-100">「下一步該往哪走？」</strong>（依據計畫路線與現地安全，確認前進的方位與路徑）</li>
          </ul>
        </div>
      ...
      <section id="s2" aria-labelledby="heading-s2" className="scroll-mt-24 mb-20">
        ...
        <div className="prose prose-invert max-w-none text-slate-300 text-base sm:text-lg leading-relaxed space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4 not-prose">
            <div className="p-5 rounded-lg border border-slate-800 bg-slate-900/90">
              <div className="flex items-center justify-between mb-2">
                <span className="font-bold text-slate-100 text-base">大比例尺（例如 1:25,000）</span>
                <span className="px-2 py-0.5 rounded text-xs font-semibold bg-emerald-950/80 border border-emerald-800/80 text-emerald-300">細節豐富</span>
              </div>
            ...
            <div className="p-5 rounded-lg border border-slate-800 bg-slate-900/90">
              <div className="flex items-center justify-between mb-2">
                <span className="font-bold text-slate-100 text-base">小比例尺（例如 1:100,000）</span>
                <span className="px-2 py-0.5 rounded text-xs font-semibold bg-slate-800 text-slate-300">區域全覽</span>
              </div>
              <p className="text-sm text-slate-400 leading-relaxed">
        ...
        <div className="prose prose-invert max-w-none text-slate-300 text-base sm:text-lg leading-relaxed space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 my-6 not-prose">
            <div className="p-4 rounded-lg border border-slate-800 bg-slate-900/90">
              <span className="text-xs font-bold text-emerald-400 uppercase tracking-wider block mb-1">基本坡度</span>
              <h4 className="font-bold text-slate-100 text-base">線密＝坡陡 · 線疏＝坡緩</h4>
            ...
            <div className="p-4 rounded-lg border border-slate-800 bg-slate-900/90">
              <span className="text-xs font-bold text-emerald-400 uppercase tracking-wider block mb-1">封閉高點</span>
              <h4 className="font-bold text-slate-100 text-base">山峰 (Peak / Summit)</h4>
              <p className="text-xs sm:text-sm text-slate-400 mt-1.5 leading-relaxed">
            ...
            <div className="p-4 rounded-lg border border-slate-800 bg-slate-900/90">
              <span className="text-xs font-bold text-emerald-400 uppercase tracking-wider block mb-1">集水低窪</span>
              <h4 className="font-bold text-slate-100 text-base">山谷 (Valley / Gully)</h4>
              <p className="text-xs sm:text-sm text-slate-400 mt-1.5 leading-relaxed">
                等高線通常呈明確的「V」字形或「U」字形，其 V 字尖端大多指向<strong className="text-slate-200">地勢較高處（上游集水方向）</strong>。
              </p>
            </div>

            <div className="p-4 rounded-lg border border-slate-800 bg-slate-900/90">
              <span className="text-xs font-bold text-emerald-400 uppercase tracking-wider block mb-1">山脊骨幹</span>
              <h4 className="font-bold text-slate-100 text-base">稜線 (Ridge)</h4>
              <p className="text-xs sm:text-sm text-slate-400 mt-1.5 leading-relaxed">
                山脊延伸的方向，兩側地勢通常急轉向下。等高線的突起部通常指向<strong className="text-slate-200">地勢較低處</strong>，視野開闊但易受強風吹襲。
              </p>
            </div>

            <div className="p-4 rounded-lg border border-slate-800 bg-slate-900/90">
              <span className="text-xs font-bold text-emerald-400 uppercase tracking-wider block mb-1">過渡低點</span>
              <h4 className="font-bold text-slate-100 text-base">鞍部 (Col / Saddle)</h4>
              <p className="text-xs sm:text-sm text-slate-400 mt-1.5 leading-relaxed">
            ...
            <div className="p-4 rounded-lg border border-slate-800 bg-slate-900/90">
              <span className="text-xs font-bold text-emerald-400 uppercase tracking-wider block mb-1">特殊地貌</span>
              <h4 className="font-bold text-slate-100 text-base">斷崖與峭壁 (Cliff)</h4>
              <p className="text-xs sm:text-sm text-slate-400 mt-1.5 leading-relaxed">
