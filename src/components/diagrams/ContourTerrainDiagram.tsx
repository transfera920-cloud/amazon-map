      ...
      <div className="w-full overflow-x-auto">
        ...
        >
          ...
          <defs>
            ...
            <linearGradient id="slope-shade" x1="0%" y1="0%" x2="0%" y2="100%">
          ...
          {/* Canvas Background */}
          <rect width="880" height="500" fill="#fafaf9" rx="8" />

          {/* Panel Dividers */}
          <rect x="20" y="20" width="400" height="430" rx="8" fill="#ffffff" stroke="#e2e8f0" strokeWidth="1.5" />
          <rect x="460" y="20" width="400" height="430" rx="8" fill="#ffffff" stroke="#e2e8f0" strokeWidth="1.5" />

          {/* Panel Headers */}
          <g transform="translate(40, 50)">
            <rect x="0" y="-14" width="140" height="26" rx="4" fill="#f1f5f9" />
            <text x="70" y="4" textAnchor="middle" fill="#0f172a" fontSize="13" fontWeight="700">
              【左】平面等高線圖
            </text>
          </g>
          ...
          <g transform="translate(220, 240)">
            ...
            <path
              ...
              strokeWidth="1.8"
            />
            <text x="-80" y="55" fill="#b45309" fontSize="9" fontWeight="bold">1200m</text>
            ...
            <path
              ...
              strokeWidth="1.5"
            />
            <circle cx="-65" cy="30" r="2.5" fill="#b45309" />
            <text x="-65" y="22" fill="#78350f" fontSize="10" fontWeight="bold" textAnchor="middle">▲ 主峰 1420m</text>
            ...
            <path
              ...
              strokeWidth="1.5"
            />
            <circle cx="48" cy="42" r="2.5" fill="#b45309" />
            <text x="50" y="32" fill="#78350f" fontSize="10" fontWeight="bold" textAnchor="middle">▲ 副峰 1310m</text>
            ...
            <line x1="-10" y1="90" x2="-10" y2="135" stroke="#0284c7" strokeWidth="1.5" markerEnd="url(#corr-arrow)" />
            <text x="5" y="115" fill="#0284c7" fontSize="9" fontWeight="bold">溪流集水線</text>

            {/* Feature Callouts in 2D */}
            {/* 1. 山峰 */}
            <g transform="translate(-140, -40)">
              <rect x="-35" y="-12" width="70" height="24" rx="4" fill="#fef2f2" stroke="#ef4444" strokeWidth="1" />
              <text x="0" y="4" fill="#991b1b" fontSize="11" fontWeight="700" textAnchor="middle">① 山峰 Peak</text>
              <line x1="20" y1="12" x2="65" y2="60" stroke="#ef4444" strokeWidth="1" strokeDasharray="2 2" />
            </g>

            {/* 2. 鞍部 */}
            <g transform="translate(-8, -40)">
              <rect x="-35" y="-12" width="70" height="24" rx="4" fill="#fefce8" stroke="#ca8a04" strokeWidth="1" />
              <text x="0" y="4" fill="#854d0e" fontSize="11" fontWeight="700" textAnchor="middle">② 鞍部 Col</text>
              <line x1="0" y1="12" x2="-10" y2="72" stroke="#ca8a04" strokeWidth="1" strokeDasharray="2 2" />
            </g>

            {/* 3. 稜線 */}
            <g transform="translate(100, -20)">
              <rect x="-35" y="-12" width="70" height="24" rx="4" fill="#f0fdf4" stroke="#16a34a" strokeWidth="1" />
              <text x="0" y="4" fill="#166534" fontSize="11" fontWeight="700" textAnchor="middle">③ 稜線 Ridge</text>
              <line x1="-15" y1="12" x2="-60" y2="55" stroke="#16a34a" strokeWidth="1" strokeDasharray="2 2" />
            </g>

            {/* 4. 山谷 */}
            <g transform="translate(-110, 180)">
              <rect x="-35" y="-12" width="70" height="24" rx="4" fill="#f0f9ff" stroke="#0284c7" strokeWidth="1" />
              <text x="0" y="4" fill="#075985" fontSize="11" fontWeight="700" textAnchor="middle">④ 山谷 Valley</text>
              <line x1="30" y1="-8" x2="85" y2="-50" stroke="#0284c7" strokeWidth="1" strokeDasharray="2 2" />
            </g>

            {/* Slope Density Indicator Bar */}
            <g transform="translate(-160, 200)">
              <rect x="0" y="0" width="320" height="30" rx="4" fill="#f8fafc" stroke="#cbd5e1" strokeWidth="1" />
              <text x="15" y="19" fill="#334155" fontSize="10" fontWeight="600">
                【坡度法則】 等高線密集 ＝ <tspan fill="#b91c1c" fontWeight="bold">坡陡</tspan>　｜　等高線稀疏 ＝ <tspan fill="#15803d" fontWeight="bold">坡緩</tspan>
              </text>
            </g>
          </g>
          ...
          <g transform="translate(425, 230)">
            <path d="M -5 -60 L 30 -60" stroke="#0284c7" strokeWidth="2" markerEnd="url(#corr-arrow)" />
            <path d="M -5 10 L 30 10" stroke="#0284c7" strokeWidth="2" markerEnd="url(#corr-arrow)" />
            <path d="M -5 80 L 30 80" stroke="#0284c7" strokeWidth="2" markerEnd="url(#corr-arrow)" />
            <text x="12" y="-70" fill="#0284c7" fontSize="10" fontWeight="bold" textAnchor="middle">空間投影</text>
          </g>
          ...
          <g transform="translate(660, 240)">
            ...
            <g transform="translate(-80, -70)">
              ...
              <line x1="0" y1="0" x2="0" y2="-25" stroke="#dc2626" strokeWidth="1.5" />
            ...
            <g transform="translate(10, 5)">
              <rect x="-35" y="-12" width="70" height="22" rx="3" fill="#fefce8" stroke="#ca8a04" strokeWidth="1" />
              <text x="0" y="3" fill="#854d0e" fontSize="10" fontWeight="bold" textAnchor="middle">鞍部 (鞍形窪凹)</text>
            </g>

            {/* Ridge Label */}
            <g transform="translate(-50, -25)">
              <rect x="-30" y="-10" width="60" height="20" rx="3" fill="#f0fdf4" stroke="#16a34a" strokeWidth="1" />
              <text x="0" y="4" fill="#166534" fontSize="10" fontWeight="bold" textAnchor="middle">稜線山脊</text>
            </g>

            {/* Valley Label */}
            <g transform="translate(25, 100)">
              <rect x="-30" y="-10" width="60" height="20" rx="3" fill="#f0f9ff" stroke="#0284c7" strokeWidth="1" />
              <text x="0" y="4" fill="#075985" fontSize="10" fontWeight="bold" textAnchor="middle">溪谷集水</text>
            </g>

            {/* Bottom 3D Footnote */}
            <g transform="translate(-160, 200)">
              <rect x="0" y="0" width="320" height="30" rx="4" fill="#f8fafc" stroke="#cbd5e1" strokeWidth="1" />
              <text x="160" y="19" fill="#334155" fontSize="10" fontWeight="600" textAnchor="middle">
