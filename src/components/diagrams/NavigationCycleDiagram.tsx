    ...
    <figure className="my-8 rounded-xl border border-stone-200 bg-white p-4 sm:p-7 shadow-xs">
      <div className="w-full overflow-x-auto">
        ...
        >
          ...
          {/* Canvas Background */}
          <rect width="800" height="440" fill="#fafaf9" rx="8" />

          {/* Left Block: 出發前 Pre-trip linear preparation */}
          <g transform="translate(30, 40)">
            <rect x="0" y="0" width="220" height="340" rx="8" fill="#ffffff" stroke="#e2e8f0" strokeWidth="1.5" />
            
            <g transform="translate(15, 20)">
              <rect x="0" y="-8" width="90" height="22" rx="3" fill="#f1f5f9" />
              <text x="45" y="7" fill="#334155" fontSize="11" fontWeight="700" textAnchor="middle">
                出發前階段
              </text>
            </g>
            ...
            <g transform="translate(20, 60)">
              <rect x="0" y="0" width="180" height="48" rx="6" fill="#f8fafc" stroke="#cbd5e1" strokeWidth="1.2" />
              <text x="12" y="22" fill="#0f172a" fontSize="13" fontWeight="700">1. 研究地圖</text>
              <text x="12" y="38" fill="#64748b" fontSize="10">熟悉整段路線走向與地標</text>
            </g>
            ...
            <g transform="translate(20, 140)">
              <rect x="0" y="0" width="180" height="48" rx="6" fill="#f8fafc" stroke="#cbd5e1" strokeWidth="1.2" />
              <text x="12" y="22" fill="#0f172a" fontSize="13" fontWeight="700">2. 建立預期</text>
              <text x="12" y="38" fill="#64748b" fontSize="10">高度變化·叉路·時程設定</text>
            </g>
            ...
            <g transform="translate(20, 220)">
              <rect x="0" y="0" width="180" height="48" rx="6" fill="#f8fafc" stroke="#cbd5e1" strokeWidth="1.2" />
              <text x="12" y="22" fill="#0f172a" fontSize="13" fontWeight="700">3. 開始行進</text>
              <text x="12" y="38" fill="#64748b" fontSize="10">攜帶雙重備援導航工具</text>
            </g>
            ...
            />
            <text x="180" y="325" fill="#047857" fontSize="11" fontWeight="700">切入行進循環</text>
          </g>

          {/* Right Block: 行進中 Continuous In-route Navigation Loop */}
          <g transform="translate(275, 40)">
            <rect x="0" y="0" width="490" height="340" rx="8" fill="#ffffff" stroke="#cbd5e1" strokeWidth="1.5" />

            <g transform="translate(20, 20)">
              <rect x="0" y="-8" width="105" height="22" rx="3" fill="#ecfdf5" />
              <text x="52" y="7" fill="#047857" fontSize="11" fontWeight="700" textAnchor="middle">
                行進中動態循環
              </text>
            </g>
            ...
            <g transform="translate(245, 175)">
              <circle cx="0" cy="0" r="48" fill="#047857" stroke="#065f46" strokeWidth="2" />
            ...
            <g transform="translate(245, 60)">
              <rect x="-85" y="-22" width="170" height="44" rx="6" fill="#f0fdf4" stroke="#047857" strokeWidth="1.5" />
              <text x="0" y="0" fill="#065f46" fontSize="13" fontWeight="700" textAnchor="middle">
                ① 確認位置
              </text>
              <text x="0" y="15" fill="#047857" fontSize="9" textAnchor="middle">
                比對目前座標或地形特徵
              </text>
            </g>
            ...
            <g transform="translate(400, 175)">
              <rect x="-65" y="-22" width="130" height="44" rx="6" fill="#f0fdf4" stroke="#047857" strokeWidth="1.5" />
              <text x="0" y="0" fill="#065f46" fontSize="13" fontWeight="700" textAnchor="middle">
                ② 比對地形
              </text>
              <text x="0" y="15" fill="#047857" fontSize="9" textAnchor="middle">
