    ...
    <figure className="my-8 rounded-xl border border-slate-800 bg-slate-900/90 p-4 sm:p-7 shadow-xs">
      <div className="w-full overflow-x-auto">
        ...
        >
          ...
          {/* Background Canvas */}
          <rect width="780" height="400" fill="#090d13" rx="8" />

          {/* Left: Compass Bezel Dial */}
          <g transform="translate(190, 200)">
            {/* Outer ring */}
            <circle cx="0" cy="0" r="140" fill="#0f172a" stroke="#334155" strokeWidth="3" />
            <circle cx="0" cy="0" r="125" fill="#090d13" stroke="#1e293b" strokeWidth="1.5" />
            <circle cx="0" cy="0" r="110" fill="#0f172a" stroke="#1e293b" strokeWidth="1" />
            ...
            {/* Cardinal Points */}
            <text x="0" y="-88" textAnchor="middle" fill="#f87171" fontSize="18" fontWeight="800">
              N (0°)
            </text>
            <text x="96" y="6" textAnchor="middle" fill="#f1f5f9" fontSize="16" fontWeight="700">
              E (90°)
            </text>
            <text x="0" y="102" textAnchor="middle" fill="#f1f5f9" fontSize="16" fontWeight="700">
              S (180°)
            </text>
            <text x="-96" y="6" textAnchor="middle" fill="#f1f5f9" fontSize="16" fontWeight="700">
              W (270°)
            ...
            <path
              ...
              strokeDasharray="3 2"
            />
            <text x="25" y="-76" fill="#34d399" fontSize="12" fontWeight="700">
              方位角 045°
            </text>
          </g>
          ...
          <g transform="translate(380, 50)">
            <rect x="0" y="0" width="370" height="300" rx="10" fill="#0f172a" stroke="#334155" strokeWidth="1.5" />
            
            <g transform="translate(20, 25)">
              <rect x="0" y="-8" width="135" height="24" rx="4" fill="#022c22" stroke="#059669" strokeWidth="1" />
              <text x="67" y="8" fill="#34d399" fontSize="12" fontWeight="700" textAnchor="middle">
                定位連動三大要素
              </text>
            </g>
            ...
            <g transform="translate(30, 80)">
              <rect x="0" y="0" width="310" height="52" rx="6" fill="#090d13" stroke="#334155" strokeWidth="1.5" />
              <circle cx="28" cy="26" r="12" fill="#0284c7" />
              <text x="28" y="30" fill="#ffffff" fontSize="11" fontWeight="bold" textAnchor="middle">1</text>
              <text x="52" y="24" fill="#f1f5f9" fontSize="14" fontWeight="700">目前位置 Current Position</text>
              <text x="52" y="42" fill="#94a3b8" fontSize="11">經由地形比對、標的物或坐標確認「我現在在哪」</text>
            </g>

            {/* Link Arrow 1 */}
            <line x1="185" y1="135" x2="185" y2="155" stroke="#10b981" strokeWidth="2" markerEnd="url(#bearing-arrow)" />

            {/* Element 2: 目標方向 */}
            <g transform="translate(30, 160)">
              <rect x="0" y="0" width="310" height="52" rx="6" fill="#022c22" stroke="#059669" strokeWidth="1.5" />
              <circle cx="28" cy="26" r="12" fill="#059669" />
              <text x="28" y="30" fill="#ffffff" fontSize="11" fontWeight="bold" textAnchor="middle">2</text>
              <text x="52" y="24" fill="#34d399" fontSize="14" fontWeight="700">目標方向 Target Bearing</text>
              <text x="52" y="42" fill="#a7f3d0" fontSize="11">由地圖求得通往目的地、鞍部或山頭之基準角度</text>
            </g>

            {/* Link Arrow 2 */}
            <line x1="185" y1="215" x2="185" y2="235" stroke="#f59e0b" strokeWidth="2" markerEnd="url(#course-arrow)" />

            {/* Element 3: 前進路線 */}
            <g transform="translate(30, 240)">
              <rect x="0" y="0" width="310" height="52" rx="6" fill="#422006" fillOpacity="0.3" stroke="#d97706" strokeWidth="1.5" />
              <circle cx="28" cy="26" r="12" fill="#d97706" />
              <text x="28" y="30" fill="#ffffff" fontSize="11" fontWeight="bold" textAnchor="middle">3</text>
              <text x="52" y="24" fill="#fde047" fontSize="14" fontWeight="700">前進路線 Course of Travel</text>
              <text x="52" y="42" fill="#fde68a" fontSize="11">沿途避開峭壁/密林，隨地形起伏動態行進的實體軌跡</text>
            </g>
          </g>
